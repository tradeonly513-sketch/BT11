...
const ProcessSection = () => {
  ...
  useOptimizedGSAP(() => {
    createOptimizedScrollTrigger('.process-title', {
      start: 'top 80%',
      onEnter: () => {
    ...
    createOptimizedScrollTrigger('.process-timeline', {
      start: 'top 75%',
      onEnter: () => {
  ...
  useOptimizedGSAP(() => {
    ...
    if (processTitle && processTitle.getBoundingClientRect().top < window.innerHeight) {
    ...
    if (processTimeline && processTimeline.getBoundingClientRect().top < window.innerHeight) {
